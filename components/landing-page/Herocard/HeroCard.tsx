...
const HeroCard = () => {
  ...
  return (
    <div className="max-w-6xl  sm:py-[.2rem] sm:px-[.4rem] md:py-[.5rem] md:px-[1.2rem] lg:py-[1rem] lg:px-[2rem] m-auto flex justify-between gap-4">
      <div className="w-[60%]  m-auto border-yellow-500">
        ...
        <div className=" md:px-[.3rem] lg:px-[.5rem]   text-left border-pink-500">
          <button className="text-white py-[.5rem]  px-[1rem] text-lg rounded-[5px] join-button">
            Join Now!
          </button>
        </div>
      </div>

      <div className="w-[40%] md:pt-[1rem] lg:py-[1rem]  m-auto border-pink-500">
